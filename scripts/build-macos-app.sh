#!/bin/bash
# Build macOS .app bundle for OctAi Launcher
...
APP_NAME="OctAi Launcher"
APP_PATH="./build/${APP_NAME}.app"
APP_CONTENTS="${APP_PATH}/Contents"
APP_MACOS="${APP_CONTENTS}/MacOS"
APP_RESOURCES="${APP_CONTENTS}/Resources"
APP_EXECUTABLE="octai-launcher"
...
if [ -f "./build/octai" ]; then
    cp "./build/octai" "${APP_MACOS}/"
else
    echo "Error: ./build/octai not found. Please build the main file first."
    echo "Run: make build"
    exit 1
fi
chmod +x "${APP_MACOS}/"*
...
<dict>
    ...
    <string>octai-launcher</string>
    <key>CFBundleIdentifier</key>
    <string>com.octai.launcher</string>
