...
var translations = map[Language]map[TranslationKey]string{
	LanguageEnglish: {
		...
		MenuOpenTooltip:    "Open AI Business HQ console in browser",
		MenuAbout:          "About",
		MenuAboutTooltip:   "About AI Business HQ",
		...
		MenuQuit:           "Quit",
		MenuQuitTooltip:    "Exit AI Business HQ",
		Exiting:            "Exiting AI Business HQ...",
		DocUrl:             "https://docs.aibhq.io/docs/",
	},
	LanguageChinese: {
		AppTooltip:         "%s - Web Console",
		MenuOpen:           "打开控制台",
		MenuOpenTooltip:    "在浏览器中打开 AI Business HQ 控制台",
		MenuAbout:          "关于",
		MenuAboutTooltip:   "关于 AI Business HQ",
		MenuVersion:        "版本: %s",
		...
		MenuQuit:           "退出",
		MenuQuitTooltip:    "退出 AI Business HQ",
		Exiting:            "正在退出 AI Business HQ...",
