...
OctAi は QQ オープンプラットフォームの公式 Bot API を通じて QQ をサポートします。
...
3. OctAi 設定ファイルに認証情報を入力する
4. `octai gateway` を実行してサービスを起動する
...
4. OctAi 設定ファイルに認証情報を入力する
5. `octai gateway` を実行してサービスを起動する
