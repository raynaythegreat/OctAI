...
AI Business HQ は QQ オープンプラットフォームの公式 Bot API を通じて QQ をサポートします。
...
3. AI Business HQ 設定ファイルに認証情報を入力する
4. `aibhq gateway` を実行してサービスを起動する
...
4. AI Business HQ 設定ファイルに認証情報を入力する
5. `aibhq gateway` を実行してサービスを起動する
