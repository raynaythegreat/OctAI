...
MaixCam 通道使 AI Business HQ 能够作为边缘设备的 AI 后端运行：

- **智能监控** ：MaixCAM 发送图像帧，AI Business HQ 通过视觉模型进行分析
- **物联网控制** ：设备发送传感器数据，AI Business HQ 协调响应
- **离线AI** ：在本地网络部署 AI Business HQ 实现低延迟推理
