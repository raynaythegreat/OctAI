...
Image `launcher` bao gồm cả ba binary (`octai`, `octai-launcher`, `octai-launcher-tui`) và khởi động web console mặc định, cung cấp giao diện trình duyệt để cấu hình và chat.
