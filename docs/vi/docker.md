...
Image `launcher` bao gồm cả ba binary (`aibhq`, `aibhq-launcher`, `aibhq-launcher-tui`) và khởi động web console mặc định, cung cấp giao diện trình duyệt để cấu hình và chat.
