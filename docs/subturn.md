...
The `SubTurn` mechanism is a core feature in OctAi that allows tools to spawn isolated, nested agent loops to handle complex sub-tasks.
...
SubTurns emit specific events to the OctAi `EventBus` for observability and debugging:
