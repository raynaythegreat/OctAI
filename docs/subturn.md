...
The `SubTurn` mechanism is a core feature in AI Business HQ that allows tools to spawn isolated, nested agent loops to handle complex sub-tasks.
...
SubTurns emit specific events to the AI Business HQ `EventBus` for observability and debugging:
