...
The `launcher` image includes all three binaries (`aibhq`, `aibhq-launcher`, `aibhq-launcher-tui`) and starts the web console by default, which provides a browser-based UI for configuration and chat.
