...
import (
	...
	anthropicprovider "github.com/raynaythegreat/ai-business-hq/pkg/providers/anthropic"
)
...
func createClaudeTokenSource() func() (string, error) {
	return func() (string, error) {
		...
		if cred == nil {
			return "", fmt.Errorf("no credentials for anthropic. Run: aibhq auth login --provider anthropic")
		}
