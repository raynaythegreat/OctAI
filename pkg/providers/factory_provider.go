...
import (
	...
	anthropicmessages "github.com/raynaythegreat/ai-business-hq/pkg/providers/anthropic_messages"
	"github.com/raynaythegreat/ai-business-hq/pkg/providers/azure"
	"github.com/raynaythegreat/ai-business-hq/pkg/providers/bedrock"
)
...
func createClaudeAuthProvider() (LLMProvider, error) {
	...
	if cred == nil {
		return nil, fmt.Errorf("no credentials for anthropic. Run: octai auth login --provider anthropic")
	}
...
func createCodexAuthProvider() (LLMProvider, error) {
	...
	if cred == nil {
		return nil, fmt.Errorf("no credentials for openai. Run: octai auth login --provider openai")
	}
