...
> **影响范围**: `pkg/channels/`, `pkg/bus/`, `pkg/media/`, `pkg/identity/`, `cmd/aibhq/internal/gateway/`
...
import (
    "github.com/raynaythegreat/ai-business-hq/pkg/bus"
    "github.com/raynaythegreat/ai-business-hq/pkg/channels"     // 引用父包
    "github.com/raynaythegreat/ai-business-hq/pkg/config"
    "github.com/raynaythegreat/ai-business-hq/pkg/identity"      // 新增
    "github.com/raynaythegreat/ai-business-hq/pkg/media"          // 新增（如需媒体）
)
```
...
import (
    _ "github.com/raynaythegreat/ai-business-hq/pkg/channels/telegram"   // 触发 init() 注册
    _ "github.com/raynaythegreat/ai-business-hq/pkg/channels/discord"
    _ "github.com/raynaythegreat/ai-business-hq/pkg/channels/your_new_channel"  // 新增
)
```
