...
> **Scope**: `pkg/channels/`, `pkg/bus/`, `pkg/media/`, `pkg/identity/`, `cmd/aibhq/internal/gateway/`
...
import (
    "github.com/raynaythegreat/ai-business-hq/pkg/bus"
    "github.com/raynaythegreat/ai-business-hq/pkg/channels"     // Reference parent package
    "github.com/raynaythegreat/ai-business-hq/pkg/config"
    "github.com/raynaythegreat/ai-business-hq/pkg/identity"      // New
    "github.com/raynaythegreat/ai-business-hq/pkg/media"          // New (if media support needed)
)
```
...
```go
// cmd/aibhq/internal/gateway/helpers.go
import (
    _ "github.com/raynaythegreat/ai-business-hq/pkg/channels/telegram"   // Triggers init() registration
    _ "github.com/raynaythegreat/ai-business-hq/pkg/channels/discord"
    _ "github.com/raynaythegreat/ai-business-hq/pkg/channels/your_new_channel"  // New addition
)
```
...
// cmd/aibhq/internal/gateway/helpers.go
import (
    _ "github.com/raynaythegreat/ai-business-hq/pkg/channels/matrix"
)
```
